...
export class ArtistService {
  ...
  addArtist(artist: Artist): Observable<HttpResponse<any>> {
    return this.httpClient.post<HttpResponse<any>>(this.url + '/add', artist, {observe: 'response'});
  }

  updateArtist(artist: Artist): Observable<HttpResponse<any>> {
    return this.httpClient.put<HttpResponse<any>>(this.url + '/update/', artist, {observe: 'response'});
  }
  ...
  deleteArtist(artistId: number): Observable<HttpResponse<any>> {
    return this.httpClient.delete<HttpResponse<any>>(this.url + `/delete/${artistId}`);
  }
